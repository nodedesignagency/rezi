...
extension JobCard {
    ...
    /// a live feed. Every row carries all five logos, and the scores span Fair,
    /// Good and Best so the gauges show all three colours. The first card of
    /// the top row is the one from the design.
    ///
    ...
    static let marqueeRows: [[JobCard]] = [
        [
            ...
            JobCard(title: "Brand Designer", salary: "$130k-160k", location: "Los Angeles, CA", score: 81, logoIndex: 4)
        ],
        [
            ...
            JobCard(title: "Backend Engineer", salary: "$190k-240k", location: "Seattle, WA", score: 92, logoIndex: 4),
        ...
        [
            ...
            JobCard(title: "Frontend Engineer", salary: "$170k-210k", location: "Remote, US", score: 85, logoIndex: 4),
        ...
        [
            ...
            JobCard(title: "Growth Marketer", salary: "$120k-150k", location: "Austin, TX", score: 90, logoIndex: 4)
        ]
    ]
}
